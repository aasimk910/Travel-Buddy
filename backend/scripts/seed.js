...
async function seedDatabase() {
  try {
    ...
    const hikesData = [
      ...
      {
        userId: adminUser._id,
        title: "Nagarkot Sunrise & Bhaktapur Heritage Walk",
        location: "Nagarkot, Kathmandu Valley",
        coordinates: { lat: 27.7100, lng: 85.5250 },
        startPoint: { lat: 27.7200, lng: 85.5300 },
        endPoint: { lat: 27.7100, lng: 85.5250 },
        difficulty: 2,
        date: new Date(Date.now() + 12 * 24 * 60 * 60 * 1000),
        spotsLeft: 17,
        imageUrl: "https://images.unsplash.com/photo-1464207687429-7505649dae38?w=800",
        description: "Wake at dawn from Nagarkot viewpoint at 2195 m to witness the Himalayan panorama bathed in golden light. Trek downhill through traditional Newari villages, terraced farmland, and rhododendron forests to the UNESCO heritage town of Bhaktapur with its medieval brick courtyards.",
        hotels: [createdHotels[2]._id],
      },
      {
        userId: adminUser._id,
        title: "Rara Lake Trek & High-Altitude Wilderness",
        location: "Rara Lake, Mugu District",
        coordinates: { lat: 29.4000, lng: 82.1500 },
        startPoint: { lat: 29.3800, lng: 82.1400 },
        endPoint: { lat: 29.4000, lng: 82.1500 },
        difficulty: 4,
        date: new Date(Date.now() + 50 * 24 * 60 * 60 * 1000),
        spotsLeft: 7,
        imageUrl: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800",
        description: "Nepal's largest and highest lake at 2990 m surrounded by pristine virgin forest rarely visited by trekkers. A true wilderness experience with endemic bird species, crystal-clear waters reflecting snow-capped peaks, and basic teahouse accommodation. Remote and rewarding.",
        hotels: [createdHotels[0]._id],
      },
      {
        userId: adminUser._id,
        title: "Gokyo Lakes & Ngozumpa Glacier Loop",
        location: "Gokyo, Khumbu Region",
        coordinates: { lat: 27.9750, lng: 86.6880 },
        startPoint: { lat: 27.9500, lng: 86.7000 },
        endPoint: { lat: 27.9750, lng: 86.6880 },
        difficulty: 4,
        date: new Date(Date.now() + 40 * 24 * 60 * 60 * 1000),
        spotsLeft: 8,
        imageUrl: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800",
        description: "Trek to six turquoise glacial lakes at 4700+ m altitude, with views of Cho Oyu and Makalu. Explore the Ngozumpa Glacier moraine, less crowded than the EBC trail but equally stunning. Gokyo Ri summit offers 360° views on clear days.",
        hotels: [createdHotels[3]._id],
      },
      {
        userId: adminUser._id,
        title: "Machhapuchhare Base Camp Trek",
        location: "Machhapuchhare, Annapurna",
        coordinates: { lat: 28.3700, lng: 83.8600 },
        startPoint: { lat: 28.3600, lng: 83.8500 },
        endPoint: { lat: 28.3700, lng: 83.8600 },
        difficulty: 3,
        date: new Date(Date.now() + 28 * 24 * 60 * 60 * 1000),
        spotsLeft: 12,
        imageUrl: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800",
        description: "Trek to the base camp of the sacred, unclimbed Machhapuchhare (Fishtail). A less-travelled route through rhododendron forests, past remote villages, and across high meadows with dramatic views of the iconic twin-peaked mountain guarding the Annapurna Conservation Area.",
        hotels: [createdHotels[0]._id],
      },
      {
        userId: adminUser._id,
        title: "Tilicho Lake & Upper Mustang Combine",
        location: "Tilicho Lake, Manang",
        coordinates: { lat: 28.7850, lng: 84.1200 },
        startPoint: { lat: 28.7700, lng: 84.1100 },
        endPoint: { lat: 28.7850, lng: 84.1200 },
        difficulty: 5,
        date: new Date(Date.now() + 55 * 24 * 60 * 60 * 1000),
        spotsLeft: 5,
        imageUrl: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800",
        description: "High-altitude alpine lake trek to 4919 m — the world's highest freshwater lake accessible by non-climbers. Combine with exploration of Upper Mustang's forbidden kingdom of ancient monasteries, isolated villages, and barren Tibetan plateaus. Advanced trekking credentials required.",
        hotels: [createdHotels[0]._id],
      },
      {
        userId: adminUser._id,
        title: "Shivapuri Peak & Nagarjun Forest Day Trek",
        location: "Shivapuri-Nagarjun National Park, Kathmandu",
        coordinates: { lat: 27.8500, lng: 85.3000 },
        startPoint: { lat: 27.8400, lng: 85.3100 },
        endPoint: { lat: 27.8500, lng: 85.3000 },
        difficulty: 2,
        date: new Date(Date.now() + 8 * 24 * 60 * 60 * 1000),
        spotsLeft: 19,
        imageUrl: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800",
        description: "A short but energetic day hike from Kathmandu to Shivapuri Peak at 2732 m with 360° views of the Kathmandu Valley and distant snow-capped Himalayan ranges. Return via the pristine Nagarjun forest trails passing prayer flags and forest temples. Perfect for a weekend escape.",
        hotels: [createdHotels[2]._id],
      },
      {
        userId: adminUser._id,
        title: "Khumbu & Rongbuk Glacier Adventure",
        location: "Rongbuk Glacier, Tibet-Nepal Border",
        coordinates: { lat: 27.9900, lng: 86.8500 },
        startPoint: { lat: 27.9800, lng: 86.8400 },
        endPoint: { lat: 27.9900, lng: 86.8500 },
        difficulty: 4,
        date: new Date(Date.now() + 60 * 24 * 60 * 60 * 1000),
        spotsLeft: 6,
        imageUrl: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800",
        description: "Explore the Tibetan side of Everest via Rongbuk Monastery and Rongbuk Glacier. Less crowded than Nepal's EBC route with equally dramatic glacier scenery. This high-altitude adventure reaches 5000+ m with extreme exposure to mountain conditions and cultural immersion in Tibetan Buddhist traditions.",
        hotels: [createdHotels[3]._id],
      },
    ];
