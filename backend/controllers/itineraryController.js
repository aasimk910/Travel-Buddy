...
function generateDemoItinerary(destination, days, budget, travelStyle, interests) {
  ...
  itinerary += `NOTE: To get AI-powered personalized itineraries, please add a valid GROQ_API_KEY to your .env file.\n`;
...
const generateItinerary = async (req, res) => {
  try {
    ...
    res.json({
      success: true,
      itinerary,
      details: { destination: destination || "(custom)", startDate, endDate, days, budget, travelStyle },
      isDemo: !useAI,
